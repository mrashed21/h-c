...
> {
  ...
  //! searchTerm=john&specialty=cardiology&appointmentFee[lt]=100 => where: { OR: [ { user.name: { contains: 'john', mode: 'insensitive' } }, { specialties.specialty.title: { contains: 'john', mode: 'insensitive' } }, { specialties.specialty.description: { contains: 'john', mode: 'insensitive' } } ], specialty: 'cardiology', appointmentFee: { lt: 100 } }
  search(): this {
  ...
  //! /doctors?include=specialties => include: { specialties: true }
  ...
  //! /doctors?include=specialties,clinic => include: { specialties: true, clinic: true }
  dynamicInclude(
